document.addEventListener("DOMContentLoaded", () => {
  ...
  // 👇TIMER : refactor creating function to managetime displaying in the correct format and use it inside
function displayTime() {  
  ...
  function showQuestion() {
    ...
    question.choices.forEach((choice) => {
      ...
      // 👉creating a li tag injecting using innerHTML:
      // const liElement = document.createElement("li");
      // liElement.innerHTML = 
      // `<input type="radio" name="choice" class="choice" value="${choice}">
      // <label>${choice}</label>
      // <br>`;
